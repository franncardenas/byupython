...
def test_get_verbs():
    ...
    for _ in range(4):
        ...
        # is one of the words in the single_verb list.
    ...
    for _ in range(4):
        ...
        # Verify that the word returned from get_verb
        # is one of the words in the single_present list.
...
def test_get_preposition():
    # 1. Test the single verbs.
    preposition = ["about", "above", "across", "after", "along", "around", "at", "before", "behind", "below", "beyond", "by", "despite", "except", "for", "from", "in", 
        "into", "near", "of", "off", "on", "onto", "out", "over", "past", "to", "under", "with", "without"]
...
def test_get_prepositional_phrase():
    ...
    for _ in range(4):
        ...
        #verify List length with split
        phrase = phrase.split()
        
        assert len(phrase) == 3
    
        list_determiner = ["a", "one", "the"]
        list_nouns = ["bird", "boy", "car", "cat", "child", "dog", "girl", "man", "rabbit", "woman"]
        list_preposition = ["about", "above", "across", "after", "along", "around", "at", "before", "behind", "below", "beyond", "by", "despite", "except", "for",
        "from", "in", "into", "near", "of", "off", "on", "onto", "out", "over", "past", "to", "under", "with", "without"]

        assert phrase[0] in list_preposition
        assert phrase[1] in list_determiner
        assert phrase[2] in list_nouns
    ...
    for _ in range(4):
        ...
        assert len(phrase) == 3
        list_determiner = ["some", "many", "the"]
        list_nouns = ["birds", "boys", "cars", "cats", "children", "dogs", "girls", "men", "rabbits", "women"]
